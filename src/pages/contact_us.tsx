...
const ContactUs = () => {
	...
	return (
		<>
			<StickyHeader />
			<main className="container-narrow pt-28 pb-20 px-4 md:pt-32 md:pb-20 md:px-8">
				<div className="max-w-4xl mx-auto space-y-6">
					...
					<div className="grid md:grid-cols-2 gap-8">
						<section id="company-details" className="rounded-2xl border border-border bg-card p-6 scroll-mt-24">
						...
						<section id="key-contacts" className="rounded-2xl border border-border bg-card p-6 scroll-mt-24">
